...
public final class OnCollisionBehaviors {
    ...
    static {
        ...
        map.put(DEFAULT_KEY, new BehaviorDef(
            "Create an explosion and remove the entity.",
            OnCollisionBehaviors::explode
        ));
    ...
    public static Map<String, BehaviorDef> registry() { return REGISTRY; }
}
