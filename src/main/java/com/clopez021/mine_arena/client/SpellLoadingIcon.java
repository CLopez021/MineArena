...
public final class SpellLoadingIcon {
    private static final ResourceLocation CAULDRON =
        ResourceLocation.fromNamespaceAndPath(MineArena.MOD_ID, "textures/screen/cauldron_sprite_sheet.png");
    ...
    public static void onChatOverlay(CustomizeGuiOverlayEvent.Chat e) {
        ...
        g.blit(CAULDRON, 0, 0, u, v, FRAME_WIDTH, FRAME_HEIGHT, FRAME_WIDTH, FRAME_HEIGHT * TOTAL_FRAMES);
        pose.popPose();
    }
}
