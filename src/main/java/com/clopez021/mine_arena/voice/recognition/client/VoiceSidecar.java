package com.clopez021.mine_arena.voice.recognition.client;

import com.clopez021.mine_arena.network.PacketHandler;
import com.clopez021.mine_arena.network.RecognizedSpeechPacket;
...
/**
 * Client-side sidecar that serves the minimal proxy page and bridges WS messages. Singleton per
 * client.
 */
public final class VoiceSidecar {
  ...
  private void handleSpeechCommand(SpeechCommand command) {
    ...
    PacketHandler.INSTANCE.send(
        new RecognizedSpeechPacket(command.getSpellName()),
